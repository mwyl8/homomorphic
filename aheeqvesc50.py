...
def ahe_query_encrypted(collection_name):
    print(f"\n=== Running encrypted-query AHE for collection: {collection_name} ===")
    ...
    database_vectors = [[int(round(val)) for val in vec] for vec in database_vectors]
...
if __name__ == "__main__":
    collections = [
        "esc50_audio_vectors_1024",
        "esc50_audio_vectors_512",
        "esc50_audio_vectors_256",
        "esc50_audio_vectors_128"
    ]
    for cname in collections:
        ahe_query_encrypted(cname)
