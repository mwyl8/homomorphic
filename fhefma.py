...
def fhe_query_encrypted_all_fma():
    collections = [
    ...
    for collection_name in collections:
        ...
        # Encrypt query vector element-wise (rounded to ints)
        ...
        def encrypted_dot_products():
            ...
            for i in range(1000):  # try first 1000 ids
...
# === Run for all 4 FMA collections ===
fhe_query_encrypted_all_fma()
