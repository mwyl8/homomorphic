...
# 3. Create collection for 256-dimensional embeddings
collection_name = "fma_1000_audio_vectors_256"
...
for i in range(num_files_to_process):
    ...
    try:
        ...
        print(f"Inserted 256-dim vector for file {mp3_files[i]} with id {i}")
