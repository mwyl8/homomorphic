...
def fhe_euclidean_fsdd_collection(client, collection_name, limit=1000):
    ...
    for i in range(limit):
        ...
        # squared euclidean: sum((q_i - d_i)^2)
...
def fhe_euclidean_all_fsdd():
    ...
    for collection_name in collections:
        fhe_euclidean_fsdd_collection(client, collection_name, limit=1000)


if __name__ == "__main__":
    fhe_euclidean_all_fsdd()
