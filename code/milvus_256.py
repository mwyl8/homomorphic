...
# ---- Create Collection (with 256-dim vectors) ----
collection_name = "audio_vector_256"
if client.has_collection(collection_name=collection_name):
    client.drop_collection(collection_name=collection_name)

client.create_collection(
    collection_name=collection_name,
    dimension=256,  # Still using 256 dimensions like your original setup
)
# ---- Prepare list of audio files ----
#folder = "/home/ec2-user/audio_files"  # change this to your audio files folder
folder = "/home/ec2-user/dataset/dataset/0"  # change this to your audio files folder
...
for i in range(num_files_to_process):
    ...
    try:
        ...
        embedding_256d = global_embedding[::4]        

        data = {
            "id": i,
            "vector": embedding_256d.tolist(),
            "text": f"test_{i}",
            "subject": "history"
        }
